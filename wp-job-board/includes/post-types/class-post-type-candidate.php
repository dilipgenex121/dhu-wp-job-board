	...
	public static function fields_resume_front( array $metaboxes ) {
		if ( ! is_admin() ) {
			...
			$fields = apply_filters( 'wp-job-board-candidate-fields-resume-front', array(
					...
					// basic info
					array(
						'name'              => __( 'Basic Contact info', 'wp-job-board' ),
						'id'                => self::$prefix . 'basic-info',
						'type'              => 'group',
						'options'     		=> array(
							'group_title'       => __( 'Basic Contact info {#}', 'wp-job-board' ),
							'add_button'        => __( 'Add Another', 'wp-job-board' ),
							'remove_button'     =>  __( 'Remove This', 'wp-job-board' ),
							'sortable'          => false,
							'closed'         => false,
						),
						'fields'			=> array(
					...
					array(
						...
						'fields'			=> array(
							...
							array(
								'name'      => __( 'years of experience', 'wp-job-board' ),

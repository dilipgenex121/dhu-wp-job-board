    ...
    WJBAjaxFileUpload.prototype = {
        ...
        upload_file: function($element) {
            $element.fileupload({
                dataType: 'json',
                dropZone: $(this),
                url: wp_job_board_file_upload.ajax_url_endpoint.toString().replace( '%%endpoint%%', 'wp_job_board_ajax_upload_file' ),
                maxNumberOfFiles: 1,
                formData: {
                    script: true,
